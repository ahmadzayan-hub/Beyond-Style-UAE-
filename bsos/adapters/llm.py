"""LLM adapter (Anthropic Messages API via httpx).

Used for text tasks (brief prose, bilingual copy scaffolds) and, wrapped by
vision.LLMVisionExtractor, for attribute extraction — where only structured
JSON leaves the adapter.
"""
